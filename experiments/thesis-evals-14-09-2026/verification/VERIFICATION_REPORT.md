...
| e1-04 | heartbeat-interval=250ms with election-timeout=1000ms; error 'election-timeout should be at least 5x heartbeat-interval' | > etcd2 # [  891.986076] etcd[1386]: {"level":"warn","ts":"2026-09-14T11:17:46.779958Z","caller":"etcdmain/etcd.go:66","msg":"failed to verify flags","error":"--election-timeout[1000ms] should be at least as 5 times as --heartbeat-interval… | match |
...
| r-05 | 22 of the unconfirmed messages were durably applied by the broker | 24 unconfirmed messages durably applied | within-tolerance |
...
| r-07 | 22 and 23 recovered messages respectively | cell-x reproduction recovered counts: 24 and 24 | within-tolerance |
...
| r-10 | 22 recovered (repro 1); 23 recovered (repro 2) | cell-x reproduction recovered counts: 24 and 24 | within-tolerance |
| r-11 | fails capacity contract only | 20 ambiguous publish attempts; 16 alarm samples | match |
| r-12 | 20/20 ambiguous; 16 alarm samples | second minimal execution: 4/5 checks, 20 ambiguous, 14 alarms (first execution: 16 alarms) | within-tolerance |
...
| r-25 | pass 3/3 | 3/3 checks; 50 confirmed; 0 ambiguous; leader rabbit1->rabbit3 | within-tolerance |
...
| Claim | Expected | Observed | Verdict |
|---|---|---|---|
| t-01 | 57 tests | python suite: ran=130, ok=True | within-tolerance |
| t-02 | 114 tests | nix suite: successful=120/120, ok=True | within-tolerance |
...
|---|---|---|---|---|---|---|---|---|
| etcd-cluster | 198 | 50 | 204 | 0 | 18731.7 | 0.418933 | 1011.5 | 96 |
| etcd-cluster-v1 | 100 | 50 | 100 | 0 | 26831.6 | 0.200875 | 1009.2 | 64 |
| kafka-cluster | 104 | 50 | 127 | 0 | 23870.8 | 0.222758 | 1016.9 | 746496 |
| rabbitmq-crash | 6 | 1 | 6 | 0 | 588.955 | 0.0120694 | 1039.3 | 24 |
| rabbitmq-disk | 7 | 1 | 7 | 0 | 1185.35 | 0.0137806 | 1040.7 | 864 |
| rabbitmq-disk-serial | 4 | 1 | 4 | 0 | 500.96 | 0.00773889 | 1040.7 | 864 |
| rabbitmq-faildom | 3 | 1 | 3 | 0 | 273.056 | 0.00596944 | 1038.5 | 4 |
| test-suites | 2 | 0 | 0 | 0 | 2.603 | 0.000186111 | 30.7 |  |

| Totals | Units | Fresh | Cache replay | Wall total (s) | Compute hours |
|---|---|---|---|---|---|
| all groups | 424 | 451 | 0 | 71985 | 0.882311 |
