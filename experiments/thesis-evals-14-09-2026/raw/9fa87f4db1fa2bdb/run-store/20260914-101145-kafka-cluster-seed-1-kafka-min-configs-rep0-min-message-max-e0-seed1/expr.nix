let
  ...
  configTarget = import (builtins.toPath "/home/freerat/projects/topotestix/experiments/kafka-cluster/kafka-cluster-min-message-max.nix") { inherit lib; };
...
orchestrate {
  ...
  name = "kafka-min-configs-rep0-min-message-max-e0-seed1";
  reportNode = "kafka1";
