...
orchestrate {
  ...
  name = "etcd-v2-exhaustive-rep0-cell080";
  reportNode = "etcd1";
  topologyChoices = (builtins.fromJSON "{\".etcdVlans\": 0, \".roles.etcd\": 0}");
  configChoices = (builtins.fromJSON "{\"etcd\": {\".services.etcd.extraConf.ELECTION_TIMEOUT\": 1, \".services.etcd.extraConf.HEARTBEAT_INTERVAL\": 0, \".services.etcd.extraConf.QUOTA_BACKEND_BYTES\": 2, \".services.etcd.extraConf.SNAPSHOT_COUNT\": 0, \".virtualisation.diskSize\": 1, \".virtualisation.memorySize\": 1}}");
