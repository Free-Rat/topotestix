...
orchestrate {
  ...
  name = "rabbitmq-crash-rep0-retune-follower-e0-seed1";
  reportNode = "rabbit1";
  topologyChoices = (builtins.fromJSON "{}");
  configChoices = (builtins.fromJSON "{\"rabbit\": {\".environment.etc.topotestix-crash-delay.text\": 1, \".environment.etc.topotestix-crash-publish-count.text\": 1, \".environment.etc.topotestix-crash-target-role.text\": 0, \".environment.etc.topotestix-crash-timing.text\": 1}}");
