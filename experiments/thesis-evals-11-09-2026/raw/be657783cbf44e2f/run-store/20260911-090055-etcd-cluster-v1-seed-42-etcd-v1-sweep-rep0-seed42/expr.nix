let
  ...
  configTarget = import (builtins.toPath "/home/freerat/projects/topotestix/targets/etcd-cluster-v1/config.nix") { inherit lib; };
  ...
  propertiesMod = import (builtins.toPath "/home/freerat/projects/topotestix/targets/etcd-cluster-v1/properties.nix") { inherit lib; };
in
orchestrate {
  seed = 42;
  inherit topologyTarget configTarget baseModule testScript;
  properties = builtins.attrValues propertiesMod;
  name = "etcd-v1-sweep-rep0-seed42";
  reportNode = "etcd1";
