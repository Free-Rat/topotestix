...
| e1-04 | heartbeat-interval=250ms with election-timeout=1000ms; error 'election-timeout should be at least 5x heartbeat-interval' | > etcd3 # [  891.030031] etcd[959]: {"level":"warn","ts":"2026-09-11T05:26:06.654364Z","caller":"etcdmain/etcd.go:66","msg":"failed to verify flags","error":"--election-timeout[1000ms] should be at least as 5 times as --heartbeat-interval[… | match |
...
| r-05 | 22 of the unconfirmed messages were durably applied by the broker | 23 unconfirmed messages durably applied | within-tolerance |
...
| r-07 | 22 and 23 recovered messages respectively | cell-x reproduction recovered counts: 23 and 23 | within-tolerance |
...
| r-10 | 22 recovered (repro 1); 23 recovered (repro 2) | cell-x reproduction recovered counts: 23 and 23 | within-tolerance |
| r-11 | fails capacity contract only | 20 ambiguous publish attempts; 17 alarm samples | within-tolerance |
| r-12 | 20/20 ambiguous; 16 alarm samples | second minimal execution: 4/5 checks, 20 ambiguous, 17 alarms (first execution: 17 alarms) | match |
...
| Claim | Expected | Observed | Verdict |
|---|---|---|---|
| t-01 | 57 tests | python suite: ran=61, ok=True | within-tolerance |
...
|---|---|---|---|---|---|---|---|---|
| etcd-cluster | 198 | 50 | 204 | 0 | 18508.8 | 0.394564 | 1038.5 | 96 |
| etcd-cluster-v1 | 100 | 50 | 100 | 0 | 26850.3 | 0.198956 | 1036.6 | 64 |
| kafka-cluster | 104 | 50 | 127 | 0 | 23237.1 | 0.209111 | 1045.9 | 746496 |
| rabbitmq-crash | 6 | 1 | 6 | 0 | 546.031 | 0.0118722 | 1047.5 | 24 |
| rabbitmq-disk | 7 | 1 | 7 | 0 | 1142.69 | 0.013875 | 1048.2 | 864 |
| rabbitmq-disk-serial | 4 | 1 | 4 | 0 | 501.501 | 0.00793333 | 1048.1 | 864 |
| rabbitmq-faildom | 3 | 1 | 3 | 0 | 263.348 | 0.00592778 | 1047.1 | 4 |
| test-suites | 2 | 0 | 0 | 0 | 2.186 | 0.000191667 | 25.9 |  |

| Totals | Units | Fresh | Cache replay | Wall total (s) | Compute hours |
|---|---|---|---|---|---|
| all groups | 424 | 451 | 0 | 71052 | 0.842431 |
