...
orchestrate {
  ...
  name = "kafka-topology-T4-leader-kill-rep-1";
  reportNode = "client1";
  topologyChoices = (builtins.fromJSON "{}");
  configChoices = (builtins.fromJSON "{\"kafka\": {\".environment.etc.topotestix-kafka-intervention.text\": 1}}");
  repetitionToken = "campaign-12-09-2026-T4-leader-kill-rep-1";
}