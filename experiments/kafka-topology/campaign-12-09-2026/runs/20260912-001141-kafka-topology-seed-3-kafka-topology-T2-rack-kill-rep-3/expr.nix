...
orchestrate {
  ...
  name = "kafka-topology-T2-rack-kill-rep-3";
  reportNode = "client1";
  topologyChoices = (builtins.fromJSON "{}");
  configChoices = (builtins.fromJSON "{\"kafka\": {\".environment.etc.topotestix-kafka-intervention.text\": 2}}");
  repetitionToken = "campaign-12-09-2026-T2-rack-kill-rep-3";
}