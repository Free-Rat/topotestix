...
orchestrate {
  ...
  name = "dev-t1-no-fault";
  reportNode = "client1";
  topologyChoices = (builtins.fromJSON "{\".clientVlans\": 0}");
  configChoices = (builtins.fromJSON "{\"kafka\": {\".environment.etc.topotestix-kafka-intervention.text\": 0, \".environment.etc.topotestix-kafka-placement.json.text\": 0}}");
  repetitionToken = "dev1";
}