let
  ...
  configTarget = import (builtins.toPath "/home/freerat/projects/topotestix/experiments/kafka-cluster/kafka-cluster-min-log-segment.nix") { inherit lib; };
...
orchestrate {
  ...
  name = "kafka-min-configs-rep0-min-log-segment-e0-seed1";
  reportNode = "kafka1";
