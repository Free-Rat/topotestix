...
orchestrate {
  ...
  name = "etcd-v2-exhaustive-rep0-cell091";
  reportNode = "etcd1";
  topologyChoices = (builtins.fromJSON "{\".etcdVlans\": 0, \".roles.etcd\": 0}");
  configChoices = (builtins.fromJSON "{\"etcd\": {\".services.etcd.extraConf.ELECTION_TIMEOUT\": 1, \".services.etcd.extraConf.HEARTBEAT_INTERVAL\": 1, \".services.etcd.extraConf.QUOTA_BACKEND_BYTES\": 1, \".services.etcd.extraConf.SNAPSHOT_COUNT\": 0, \".virtualisation.diskSize\": 1, \".virtualisation.memorySize\": 1}}");
