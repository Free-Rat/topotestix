...
orchestrate {
  ...
  name = "etcd-v2-exhaustive-rep0-cell003";
  reportNode = "etcd1";
  topologyChoices = (builtins.fromJSON "{\".etcdVlans\": 0, \".roles.etcd\": 0}");
  configChoices = (builtins.fromJSON "{\"etcd\": {\".services.etcd.extraConf.ELECTION_TIMEOUT\": 0, \".services.etcd.extraConf.HEARTBEAT_INTERVAL\": 0, \".services.etcd.extraConf.QUOTA_BACKEND_BYTES\": 0, \".services.etcd.extraConf.SNAPSHOT_COUNT\": 1, \".virtualisation.diskSize\": 0, \".virtualisation.memorySize\": 0}}");
